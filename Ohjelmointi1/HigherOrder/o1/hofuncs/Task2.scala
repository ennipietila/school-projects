...
object Task2 extends App {
  ...
  //    green noise. 
  def revealPixel(color: Color) = {
    Color(color.red * 10, 0, color.blue)
  }
  //
  ...
  val solvedPic = scrambledPic.transformColors(revealPixel) // TODO: should use transformColors to reveal the hidden image   
