...
object factory {
  ...
  def buildBusWriteUnit4(r0: Bus, r1: Bus, r2: Bus, r3: Bus,
    ...
    (((r0 && !writeEnable) | ((r0 && writeEnable && !(!writeTo(0) && !writeTo(1))) | (data && writeEnable && !writeTo(0) && !writeTo(1)))) && !reset,
     ((r1 && !writeEnable) | ((r1 && writeEnable && !(writeTo(0) && !writeTo(1))) | (data && writeEnable && writeTo(0) && !writeTo(1)))) && !reset,
     ((r2 && !writeEnable) | ((r2 && writeEnable && !(!writeTo(0) && writeTo(1))) | (data && writeEnable && !writeTo(0) && writeTo(1)))) && !reset,
     ((r3 && !writeEnable) | ((r3 && writeEnable && !(writeTo(0) && writeTo(1))) | (data && writeEnable && writeTo(0) && writeTo(1)))) && !reset)
